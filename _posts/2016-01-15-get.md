...
Any string data can be stord. If you need to namespace your data, the redis community have the answer, prepend your keys with your namespace `mynamespace:name`. Stord.io doesn't assume anything about your data, make whatever nested schema you want!
